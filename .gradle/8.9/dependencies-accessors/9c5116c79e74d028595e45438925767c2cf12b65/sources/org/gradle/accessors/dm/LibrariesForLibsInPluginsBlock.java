...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxNavLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.nav.compose");
        }
    ...
    public static class KotlinxSerializationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>json.serialization</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VisionLibraryAccessors extends SubDependencyFactory {
        private final VisionInternalLibraryAccessors laccForVisionInternalLibraryAccessors = new VisionInternalLibraryAccessors(owner);

        public VisionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>vision.internal</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public VisionInternalLibraryAccessors getInternal() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForVisionInternalLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class VisionInternalLibraryAccessors extends SubDependencyFactory {

        public VisionInternalLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>vkp</b> with <b>com.google.mlkit:vision-internal-vkp</b> coordinates and
         * with version reference <b>visionInternalVkp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getVkp() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("vision.internal.vkp");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>healthConnect</b> with value <b>1.1.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>visionInternalVkp</b> with value <b>18.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVisionInternalVkp() { return getVersion("visionInternalVkp"); }
    ...
    public static class JsonVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>json.serialization</b> with value <b>1.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSerialization() { return getVersion("json.serialization"); }
    ...
    public static class NavVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>nav.version</b> with value <b>2.8.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
